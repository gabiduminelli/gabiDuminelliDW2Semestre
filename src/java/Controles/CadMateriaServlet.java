 ...
 * @author Gabi
 */
@WebServlet(name = "CadMateriaServlet", urlPatterns = {"/cadastromateria"})
public class CadMateriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            response.sendRedirect(request.getContextPath() + "/paginas/materiacad.jsp");
        }
    }
